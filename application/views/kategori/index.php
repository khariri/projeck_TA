                    ...
                    <div class="card">
                        ...
                        <div class="body">
							...
							if(isset($status) && $status == 'success'){ 
								...
								function(isConfirm){
								if (isConfirm) {
								window.location.href = "v_kategori";';
								echo '}});';
								echo '}, 1000);</script>';
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>													
												...
												<a href="#"><button type="button" class="btn btn-danger btn-xs waves-effect" onclick="confirmDel('<?=$value['id_kategori'];?>')">
...
echo '<script type="text/javascript">
	...
	echo 'window.location.href = "delete_kategori" + "/" + a;';
	echo '} else {
